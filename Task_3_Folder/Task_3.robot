...
Buying Contract
    Wait Until Page Contains Element    //button[@class='btn-purchase btn-purchase--2']    120
    Wait Until Element Is Visible  //button[@class='btn-purchase btn-purchase--2']    120
